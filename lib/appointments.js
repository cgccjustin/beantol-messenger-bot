  ...
  if (session.step === "time") {
    ...
    if (!result?.ok) {
      return {
        handled: true,
        reply:
          "I noted your preferred visit time. Our team will confirm shortly — shop hours Mon–Fri. You can also message during 9 AM–9 PM to speak with someone live.",
      };
    }
    ...
    return {
      ...
      reply:
        ...
        `Our team will confirm by chat or phone. Shop is open Mon–Fri — see KNOWLEDGE for hours and address.`,
      appointment: ap,
    };
  }
