...
function renderNav(active, token) {
  const t = encodeURIComponent(token || "");
  const mainTabs = [
    { id: "overview", label: "Overview", href: `/admin?token=${t}` },
    { id: "handoffs", label: "Handoffs", href: `/admin/handoffs/view?token=${t}` },
    { id: "webhooks", label: "Webhook log", href: `/admin/webhook-log?token=${t}` },
    { id: "instagram", label: "Instagram", href: `/admin/instagram-setup/view?token=${t}` },
    { id: "analytics", label: "Analytics", href: `/admin/analytics/view?token=${t}` },
    { id: "sales", label: "Sales", href: `/admin/sales/view?token=${t}` },
    { id: "leads", label: "Leads", href: `/admin/leads/view?token=${t}` },
    { id: "appointments", label: "Appointments", href: `/admin/appointments/view?token=${t}` },
    { id: "orders", label: "Orders", href: `/admin/orders/view?token=${t}` },
    { id: "quotes", label: "Quotes", href: `/admin/quotes/view?token=${t}` },
    { id: "inventory", label: "Inventory", href: `/admin/inventory/view?token=${t}` },
    { id: "closures", label: "Closures", href: `/admin/closures/view?token=${t}` },
    { id: "tools", label: "Tools", href: `/admin/tools/view?token=${t}`, tools: true },
  ];
...
function renderPage({ title, active, token, body, flash = "", bookmark = false, req = null }) {
