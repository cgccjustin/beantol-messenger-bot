...
function buildProposal(userText, assistantReply = "", options = {}) {
  ...
  const effectiveKg = resolveEffectiveOrderKg(userText, recentTexts, sessionQuote);
  const wholesale = detectWholesale(userText, assistantReply, recentTexts, sessionQuote);
