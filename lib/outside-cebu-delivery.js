...
function getOutsideCebuSystemNote() {
  return (
    "OUTSIDE CEBU DELIVERY (strict — overrides Maxim / weekend delivery wording for this topic):\n" +
    "- Maxim is Cebu-area local delivery ONLY. Never mention Maxim for Luzon, Visayas outside Cebu, Manila, or any 'outside Cebu' / nationwide question.\n" +
