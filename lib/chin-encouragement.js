...
const FAITH_OPEN_TO_ALL_TENANTS = new Set(["beantol", "offbeat-brew", "kape-kristiano"]);
...
function shouldUseFaithEncouragement(tenant, recipient, userText, options = {}) {
  ...
  if (!rosterRecipient) return false;
  return !isFaithProfileBusinessMessage(userText, tenant, rosterRecipient, options);
}
